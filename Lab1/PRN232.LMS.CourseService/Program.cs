...
using PRN232.LMS.CourseService.Infrastructure;
using PRN232.LMS.CourseService.Repositories;
...
builder.Services.AddDbContext<LmsDbContext, CourseDbContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("CourseDb")));
builder.Services.AddScoped<ICourseRepository, CourseRepository>();
builder.Services.AddScoped<ISemesterRepository, SemesterRepository>();
builder.Services.AddScoped<IEnrollmentRepository, CourseEnrollmentRepository>();
builder.Services.AddScoped<ICourseService, CourseService>();
builder.Services.AddScoped<IEnrollmentService, EnrollmentService>();
builder.Services.AddScoped<IStudentLookupClient, GrpcStudentLookupClient>();

builder.Services.AddGrpcClient<StudentLookup.StudentLookupClient>(options =>
{
    var address = builder.Configuration["StudentGrpc:Address"] ?? "http://localhost:9082";
